...
describe('Robots.txt Analyzer Tool', () => {
    ...
    test('handles missing robots.txt gracefully', async () => {
        ...
        await expect(analyzeRobots('https://example.com'))
            .rejects
            .toThrow('Failed to analyze robots.txt: HTTP error! status: 404');
    });
    ...
    test('handles network errors gracefully', async () => {
        ...
        await expect(analyzeRobots('https://example.com'))
            .rejects
            .toThrow('Failed to analyze robots.txt: Network error');
    });
}); 